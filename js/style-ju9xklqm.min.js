...
function buildPageTitles() {
  ...
  let url = './data/styles.json';
  const result = await fetch(url);
  const style = await result.json();
...
async function init() {
  ...
  let url = `https://z2s71hp3o9.execute-api.us-east-1.amazonaws.com/default/beer-styles?id={id}&pageId={pageId}`;
